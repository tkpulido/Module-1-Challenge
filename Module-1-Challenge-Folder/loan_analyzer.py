...
print(f"The total value of the loans results to {total_value}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average = total_value / number_of_loans
...
def calculate_present_value(future_value_parameter, remaining_months_parameter, annual_discount_rate):
    present_value = future_value_parameter / (1 + (annual_discount_rate/12))**remaining_months_parameter
